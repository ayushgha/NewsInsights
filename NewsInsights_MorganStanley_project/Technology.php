...
$sql = ("SELECT SUM(frequency) as freq FROM technology WHERE keywrd='HDFC' GROUP BY day ORDER BY day ");
...
//arr[0]={y: parseInt(jArrFreq[0]['freq'])};
console.log(arr);
...
$sql = "SELECT SUM(frequency) as freq FROM technology WHERE keywrd='Tesla' GROUP BY day ORDER BY day";
$result = $conn->query($sql);
...
$sql = "SELECT SUM(frequency) as freq FROM technology WHERE keywrd='Aviation' GROUP BY day ORDER BY day ";
$result = $conn->query($sql);
...
$sql = "SELECT SUM(frequency) as freq FROM technology WHERE keywrd='GST' GROUP BY day ORDER BY day";
$result = $conn->query($sql);
