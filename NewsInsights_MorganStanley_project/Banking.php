...
$sql = ("SELECT SUM(frequency) as freq FROM banking WHERE keywrd='HDFC' GROUP BY day ORDER BY day ");
// SELECT freq FROM (SELECT SUM(freq), day FROM business WHERE keyword='HDFC' GROUP BY day) x ORDER BY x.day
//$sql = ("SELECT f from (SUM(freq) as f FROM business WHERE keyword='HDFC' GROUP BY day) ORDER BY day ");
...
$sql = "SELECT SUM(frequency) as freq FROM banking WHERE keywrd='Tesla' GROUP BY day ORDER BY day";
$result = $conn->query($sql);
...
$sql = "SELECT SUM(frequency) as freq FROM banking WHERE keywrd='Aviation' GROUP BY day ORDER BY day ";
$result = $conn->query($sql);
...
$sql = "SELECT SUM(frequency) as freq FROM banking WHERE keywrd='GST' GROUP BY day ORDER BY day";
$result = $conn->query($sql);
