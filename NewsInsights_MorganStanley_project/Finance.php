...
$sql = ("SELECT SUM(frequency) as freq FROM finance WHERE keywrd='HDFC' GROUP BY day ORDER BY day ");
// SELECT freq FROM (SELECT SUM(freq), day FROM business WHERE keyword='HDFC' GROUP BY day) x ORDER BY x.day
//$sql = ("SELECT f from (SUM(freq) as f FROM business WHERE keyword='HDFC' GROUP BY day) ORDER BY day ");
...
$sql = "SELECT SUM(frequency) as freq FROM finance WHERE keywrd='Tesla' GROUP BY day ORDER BY day";
$result = $conn->query($sql);
...
$sql = "SELECT SUM(frequency) as freq FROM finance WHERE keywrd='Aviation' GROUP BY day ORDER BY day ";
$result = $conn->query($sql);
...
$sql = "SELECT SUM(frequency) as freq FROM finance WHERE keywrd='GST' GROUP BY day ORDER BY day";
$result = $conn->query($sql);
